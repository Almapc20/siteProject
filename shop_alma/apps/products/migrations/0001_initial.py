# Generated by Django 5.1.3 on 2025-02-12 22:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summery_description', models.TextField(blank=True, default='', null=True, verbose_name='توضیحات کالا')),
                ...
                ('brand', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='brands', to='products.brand', verbose_name='برنند کالا')),
            ],
            options={
                'verbose_name': ' کالا',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_value', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.featurevalue', verbose_name='product_feature_value')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_name', models.ImageField(upload_to=utils.FileUpload.upload_to, verbose_name='تصویر کالا')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='galery_images', to='products.product', verbose_name='کالا')),
            ],
            options={
                'verbose_name': 'تصویر',
        ...
        migrations.AddField(
            model_name='product',
            name='product_group',
            field=models.ManyToManyField(related_name='product_of_groups', to='products.productgroup', verbose_name='گروه کالا'),
        ),
        migrations.AddField(
            model_name='feature',
            name='product_group',
            field=models.ManyToManyField(related_name='feature_of_groups', to='products.productgroup', verbose_name='گروه کالا'),
        ),
    ]
